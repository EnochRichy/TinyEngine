...
add_executable(ML_OV7670_GFX_default_image_ENuhp3_n ${ML_OV7670_GFX_default_library_list})

if(NOT CMAKE_HOST_WIN32)
    set_target_properties(ML_OV7670_GFX_default_image_ENuhp3_n PROPERTIES RUNTIME_OUTPUT_DIRECTORY "${ML_OV7670_GFX_default_output_dir}")
endif()
set_target_properties(ML_OV7670_GFX_default_image_ENuhp3_n PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf")
target_link_libraries(ML_OV7670_GFX_default_image_ENuhp3_n PRIVATE ${ML_OV7670_GFX_default_default_XC32_FILE_TYPE_link})

# Add the link options from the rule file.
ML_OV7670_GFX_default_link_rule( ML_OV7670_GFX_default_image_ENuhp3_n)

# Call bin2hex function from the rule file
ML_OV7670_GFX_default_bin2hex_rule(ML_OV7670_GFX_default_image_ENuhp3_n)
if(CMAKE_HOST_WIN32)
    add_custom_command(
        TARGET ML_OV7670_GFX_default_image_ENuhp3_n
        POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E make_directory ${ML_OV7670_GFX_default_output_dir}
        COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:ML_OV7670_GFX_default_image_ENuhp3_n> ${ML_OV7670_GFX_default_output_dir}/${ML_OV7670_GFX_default_original_image_name}
