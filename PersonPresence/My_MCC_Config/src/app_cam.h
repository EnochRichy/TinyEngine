...
// MCUNet-VWW0 model input dimensions (HWC int8, 64x64x3)
 ...
 *
 * Full-frame bilinear resize 160x120 -> 64x64 (no crop; matches MCUNet
 * eval_torch.py Resize((64,64)), which deliberately squashes aspect rather
