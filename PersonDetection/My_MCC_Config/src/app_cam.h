...
// Person-detection model input dimensions (HWC int8)
 ...
 * into a 128x160x3 HWC int8 tensor for TinyEngine person detection.
 *
 * The Y axis is upscaled 120 -> 128 by nearest-neighbor; X axis is 1:1.
