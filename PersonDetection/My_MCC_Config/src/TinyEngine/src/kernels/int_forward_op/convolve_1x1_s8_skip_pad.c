...
tinyengine_status convolve_1x1_s8_skip_pad(const q7_t *input, const uint16_t input_x, const uint16_t input_y,
                                           ...
                                           const uint16_t output_ch, q15_t *runtime_buf, const uint16_t pad_t,
                                           const uint16_t pad_b, const uint16_t pad_l, const uint16_t pad_r) {
    int32_t i_element;
    (void)input_x;
    (void)input_y;
