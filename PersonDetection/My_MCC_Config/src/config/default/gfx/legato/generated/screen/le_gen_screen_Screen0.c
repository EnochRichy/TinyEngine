...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_mhgsLogo->fn->setSize(Screen0_mhgsLogo, 167, 128);
    ...
    Screen0_mhgsLogo->fn->setImage(Screen0_mhgsLogo, (leImage*)&panda_scaled);
    root0->fn->addChild(root0, (leWidget*)Screen0_mhgsLogo);

    Screen0_ImageWidget_0 = leImageWidget_New();
    Screen0_ImageWidget_0->fn->setPosition(Screen0_ImageWidget_0, 279, 71);
    Screen0_ImageWidget_0->fn->setSize(Screen0_ImageWidget_0, 105, 98);
    Screen0_ImageWidget_0->fn->setBorderType(Screen0_ImageWidget_0, LE_WIDGET_BORDER_NONE);
    Screen0_ImageWidget_0->fn->setImage(Screen0_ImageWidget_0, (leImage*)&gesture);
